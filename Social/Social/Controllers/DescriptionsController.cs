...
namespace Social.Controllers
{
    public class DescriptionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "descriptionID,background,height,name,powers,weight")] Description description)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "descriptionID,background,height,name,powers,weight")] Description description)
        {
            if (ModelState.IsValid)
            {
